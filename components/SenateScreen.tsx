            ...
            <View style={styles.section}>
              ...
              {leadership.map(leader => (
                <View key={`leader-${leader.roster_key}`} style={styles.legislatorCard}>
                  ...
                  {leader.leg_status && (
                    <Text style={styles.committees}>Status: {leader.leg_status}</Text>
                  )}
                </View>
              ))}
            </View>
            ...
            <View style={styles.section}>
              ...
              {recentBills.map(bill => (
                <TouchableOpacity key={bill.bill_key} style={styles.legislatorCard}>
                  <Text style={styles.legislatorName}>{bill.actual_bill_number || bill.bill_key}</Text>
              ...
              {senators.map((legislator) => (
                <View key={`senator-${legislator.roster_key}`} style={styles.legislatorCard}>
                  ...
                  {legislator.leg_status && (
                    <Text style={styles.committees}>Status: {legislator.leg_status}</Text>
                  )}
                </View>
              ))}
            </View>
